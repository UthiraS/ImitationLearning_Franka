...
if __name__=='__main__':
    it=InsertionViewer(num_episodes=10, max_t=4096,
                       weight_name="logs/best_model/1228800steps_05042021_0701_PPO21/best_model", #For loading weights
                       show_sim=False, verbose=True, live_plot=False, save_obs_data=True)
    it.view_sim()