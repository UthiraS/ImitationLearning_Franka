...
Policy7D1=("IL_large" "ImitationLearningMinusHard"
          "/active_vision/policyTester/ILPolicy" "Train_set_large_FPFH")      
# Policy7D2=("IL_large" "ImitationLearningMinusHard"
#           "/active_vision/policyTester/ILPolicy" "Train_set_large_GRSD")     
# Policy7D3=("IL_large" "ImitationLearningMinusHard"
# "/active_vision/policyTester/ILPolicy" "Train_set_large_CVFH")    
  ...
  rosparam set /active_vision/policyTester/nDataPoints $nDataPoints
    ...
    for stVec in ${files[@]}; do
      ...
      if [[ "$policy" == "HEURISTIC" ]]; then
        ...
        screen -S session-policyService -X stuff $'source ~/Envs/AVRL/bin/activate\nrosrun active_vision trainedPolicyServiceIL.py\n'
  			screen -S session-policyTester -X stuff $'rosrun active_vision policyTester 2\n1\n exit\n'
