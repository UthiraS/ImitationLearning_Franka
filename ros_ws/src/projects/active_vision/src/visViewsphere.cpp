...
int main(int argc, char** argv){
  ...
  viewer->addCube(table.x-0.1,table.x+0.1,
                  table.y-0.1,table.y+0.1,
                  table.z,table.z+0.2,0.9,0.0,0.0,"Box",vp[0]);
  ...
  viewer->setCameraPosition(-3,-3,3,table.x,table.y,table.z,0,0,1);
